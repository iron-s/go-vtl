...
func TestParse(t *testing.T) {
	tests := []Test{
		...
		{"short var reference",
			"$var_1",
			[]Node{&VarNode{&RefNode{"var_1"}, nil, false}},
		},
		{"short and formal reference",
			"$var${var}",
			[]Node{&VarNode{&RefNode{"var"}, nil, false}, &VarNode{&RefNode{"var"}, nil, false}},
		},
		...
		{"silent short var reference",
			"$!var",
			[]Node{&VarNode{&RefNode{"var"}, nil, true}},
		},
		...
		{"formal method notation with params",
			...
			[]Node{&VarNode{
				&RefNode{"customer1"},
				[]*AccessNode{{"setAddress", []*OpNode{{Val: &InterpolatedNode{Items: []Node{TextNode("Somewhere")}}}}, true}},
				false,
			}},
		},
		{"regular method notation with expression in params",
			...
			[]Node{&VarNode{
				&RefNode{"customer1"},
				[]*AccessNode{{"setAddress", []*OpNode{{Op: "+", Left: &OpNode{Val: &InterpolatedNode{Items: []Node{TextNode("Somewhere")}}}, Right: &OpNode{Val: int64(1)}}}, true}},
				false,
			}},
		},
		...
		{"set dirctive with var reference",
			`#set( $monkey = $bill )`,
			[]Node{&SetNode{
				&VarNode{&RefNode{"monkey"}, nil, false},
				&OpNode{Val: &VarNode{&RefNode{"bill"}, nil, false}},
			}},
		},
		{"set directive with string literal",
			`#set( $monkey.Friend = 'monica' )`,
			[]Node{&SetNode{
				&VarNode{&RefNode{"monkey"}, []*AccessNode{{"Friend", nil, false}}, false},
				&OpNode{Val: "monica"},
			}},
		},
		{"set directive with number literal",
			...
			[]Node{&SetNode{
				&VarNode{&RefNode{"monkey"}, []*AccessNode{{"Number", nil, false}}, false},
				&OpNode{Val: int64(123)},
			}},
		},
		{"set directive with property reference",
			`#set( $monkey.Blame = $whitehouse.Leak )`,
			[]Node{&SetNode{
				&VarNode{&RefNode{"monkey"}, []*AccessNode{{"Blame", nil, false}}, false},
				&OpNode{Val: &VarNode{&RefNode{"whitehouse"}, []*AccessNode{{"Leak", nil, false}}, false}},
			}},
		},
		{"set directive with method reference",
			`#set( $monkey.Plan = $spindoctor.weave($web) )`,
			[]Node{&SetNode{
				&VarNode{&RefNode{"monkey"}, []*AccessNode{{"Plan", nil, false}}, false},
				&OpNode{Val: &VarNode{
					&RefNode{"spindoctor"},
					[]*AccessNode{{"weave", []*OpNode{{Val: &VarNode{&RefNode{"web"}, nil, false}}}, true}}, false}},
			}},
		},
		{"set directive with range operator",
			`#set( $monkey.Numbers = [1..3] )`,
			[]Node{&SetNode{
				&VarNode{&RefNode{"monkey"}, []*AccessNode{{"Numbers", nil, false}}, false},
				&OpNode{Op: "range", Left: &OpNode{Val: int64(1)}, Right: &OpNode{Val: int64(3)}},
			}},
		},
		...
		{"set directive with arithmetic RHS",
			`#set( $value = $foo + 1 )`,
			[]Node{&SetNode{
				&VarNode{&RefNode{"value"}, nil, false},
				&OpNode{Op: "+", Left: &OpNode{Val: &VarNode{&RefNode{"foo"}, nil, false}}, Right: &OpNode{Val: int64(1)}},
			}},
		},
		{"set directive with complex arithmetic RHS",
			...
			[]Node{&SetNode{
				&VarNode{&RefNode{"value"}, nil, false},
				&OpNode{Op: "*", Left: &OpNode{Val: &VarNode{&RefNode{"foo"}, nil, false}}, Right: &OpNode{Op: "+", Left: &OpNode{Val: int64(3)}, Right: &OpNode{Val: int64(1)}}},
			}},
		},
		...
		{"condition simple",
			`#if( !$foo )42#end`,
			[]Node{&IfNode{
				&OpNode{Op: "not", Left: &OpNode{Val: &VarNode{&RefNode{"foo"}, nil, false}}},
				[]Node{TextNode("42")},
				nil,
			}},
		},
		...
		{"condition with else",
			...
			[]Node{&IfNode{
				&OpNode{Op: "eq", Left: &OpNode{Val: &VarNode{&RefNode{"foo"}, nil, false}}, Right: &OpNode{Val: int64(42)}},
				[]Node{TextNode("42")},
				&IfNode{nil, []Node{TextNode("not!")}, nil},
			}},
		},
		...
		{"condition with elseif",
			...
			[]Node{&IfNode{
				...
				[]Node{TextNode("42")},
				&IfNode{
					&OpNode{Op: "gt", Left: &OpNode{Val: &VarNode{&RefNode{"foo"}, nil, false}}, Right: &OpNode{Val: int64(3)}},
					[]Node{TextNode(`$foo > 3`)},
					&IfNode{nil, []Node{}, nil}},
			}},
		},
		...
		t.Run(test.operator, func(t *testing.T) {
			...
			if test.err != "" {
				...
				expected := []Node{&IfNode{
					&OpNode{Op: test.expected, Left: &OpNode{Val: &VarNode{&RefNode{"foo"}, nil, false}}, Right: &OpNode{Val: int64(42)}},
					[]Node{TextNode("42")},
					nil,
				}}
